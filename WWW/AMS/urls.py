...
urlpatterns = [
	...
	url(r'^problem_update/(?P<problem_number>[0-9]+)$', views.problem_update, name='problem_update'),
	...
	url(r'^answer_submit/(?P<problem_number>[0-9]+)$', views.answer_submit, name='answer_submit'),
